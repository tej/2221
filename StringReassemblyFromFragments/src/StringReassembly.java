...
public final class StringReassembly {
    ...
    public static String combination(String str1, String str2, int overlap) {
        ...
        String str1NoSuff = str1.substring(0, str1.length() - overlap);
        String ret = str1NoSuff + str2;
        /*
    ...
    public static void addToSetAvoidingSubstrings(Set<String> strSet,
        ...
        if (strSet.size() == 0) {
            ...
            //Checking to see if it is not a substring of any string already in
            Set<String> temp = strSet.newInstance();

            while (strSet.size() > 0) {
                String x = strSet.removeAny();
                if (x.contains(str)) {
                    //System.out.println("Error, cannot add string into set becuase it is a subset of another string in set");
                    notSubString = false;
                }
                temp.add(x);
            }
            if (notSubString == true) {
                while (temp.size() > 0) {
    ...
    public static void main(String[] args) {
        ...
        /*
         * System.out.println("Enter String 1"); String str1 =
         * keyboard.nextLine();
         *
         * System.out.println("Enter String 2"); String str2 =
         * keyboard.nextLine();
         *
         * int overlap = overlap(str1, str2); System.out.println("overlap: " +
         * overlap);
         *
         * String combination = combination(str1, str2, overlap);
         * System.out.println("This is the combination " + combination);
         *
         */
