...
public final class NaturalNumberRoot {
    ...
    public static void root(NaturalNumber n, int r) {
        ...
        NaturalNumber gPower = new NaturalNumber2();
        ...
        while (difference.compareTo(one) > 0) {
            ...
            gPower.copyFrom(guess);
            gPower.power(r);

            if (gPower.compareTo(n) > 0) {
                high.copyFrom(guess);
            } else if (gPower.compareTo(n) == 0) {
                // if guess^r == n exit loop and return guess
                low.copyFrom(guess);
                difference.copyFrom(one);
            } else {
                // if guess^r < n, low = guess
                low.copyFrom(guess);
            }
